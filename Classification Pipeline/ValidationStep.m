...
%%% ################################################################### %%%
%%
function [T,AUC,ROC_X,ROC_Y] = ValidationStep(z,I_C_mean,I_NC_mean,Distance,N_patients_C,N_patients_NC,featC2,outcome1,ord,featC2_test,outcome_test,Distance_test)
